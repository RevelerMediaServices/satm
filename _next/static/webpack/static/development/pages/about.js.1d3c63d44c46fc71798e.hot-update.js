...
})([".navbar-nav{float:none;margin:0 auto;display:block;text-align:center;}.navbar-nav > li{display:block;float:none;}@media (min-width:768px){.navbar-nav{float:none;margin:0 auto;display:block;text-align:center;}.navbar-nav > li{display:inline-block;float:none;}}.customButtonWidth{width:10vw;}"]);
  ...
  _createClass(Navbar1, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(NavBarDiv, {
        ...
        className: "btn-group-sm bg-white rounded-left customButtonGroup",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 79
        },
...
//# sourceMappingURL=about.js.1d3c63d44c46fc71798e.hot-update.js.map
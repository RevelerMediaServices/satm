...
})(["position:absolute;top:30vh;left:40vw;ul{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);margin:0;padding:0;display:flex;background-color:rgba(8,80,8,1);border-radius:10%;padding:2vw;}ul li{list-style:none;}ul li a{width:5vw;height:5vw;display:block;margin:0 0.75vw;border-radius:50%;font-size:2.5vw;padding-top:0.8vw;padding-left:1.1vw;box-sizing:border-box;text-decoration:none;box-shadow:0px 0px 0px 8px #000000,0px 0px 0px 16px #4b4c4b,0px 0px 0px 24px #828482,0px 0px 0px 31px #b2b5b2,0px 0px 0px 39px #daddda,5px 5px 15px 5px rgba(0,0,0,0);background:linear-gradient(0deg,#ddd,#fff);transition:0.75s;color:rgba(192,8,8,1);border:black 0.1vw;border-style:solid dashed;}ul li a:hover{box-shadow:0 0.05vw 0.125vw rgba(0,0,0,0.3);color:rgba(8,80,8,1);}ul li a .fa{width:100%;height:100%;display:block;background:linear-gradient(0deg,#fff,#ddd);border-radius:50%;line-height:calc(6vw - 1.25vw);font-size:2.5vw;color:white;transition:0.5s;}"]);
...
//# sourceMappingURL=index.js.442f223665feb19e3063.hot-update.js.map
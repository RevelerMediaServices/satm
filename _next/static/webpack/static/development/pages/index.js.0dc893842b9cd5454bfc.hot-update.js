...
})(["position:absolute;top:15vh;left:10vw;background:rgba(192,19,19,0.7);border:1vmax double rgba(7,80,8,1);border-radius:2vmax;font-weight:0;#borderdiv{margin:1vmax;border-radius:0.5vmax;}.animatedDiv{color:black;width:40vw;font-size:2.5vw;padding-left:5vw;padding-bottom:1vh;}.bringingJoy{}.permianBasin{}"]);
var config = {
  mass: 5,
  tension: 2000,
  friction: 5000
...
function IndexAnimation() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(IndexAnimationDiv, {
    ...
    __self: this
  }, "to the Permian Basin")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    id: "borderdiv",
    style: {
...
//# sourceMappingURL=index.js.0dc893842b9cd5454bfc.hot-update.js.map
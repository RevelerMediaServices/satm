...
})(["font-family:\"Romanesco\",cursive;position:absolute;top:15vh;left:10vw;background:#a81414;background:linear-gradient(90deg,#a81414 0%,#125712 80%);background:-webkit-linear-gradient(90deg,#a81414 0%,#125712 80%);background:-moz-linear-gradient(90deg,#a81414 0%,#125712 80%);border-radius:10px 10px 10px 10px;-webkit-border-radius:10px 10px 10px 10px;-moz-border-radius:10px 10px 10px 10px;.animatedDiv{color:white;width:40vw;font-size:5vw;padding-left:5vw;padding-bottom:1vh;}.bringingJoy{}.permianBasin{}"]);
var config = {
  mass: 5,
  tension: 2000,
  friction: 5000
...
//# sourceMappingURL=index.js.f2e53c73957df3bbb982.hot-update.js.map
...
})(["font-family:\"Charm\",cursive;font-size:2vw;.btn-red{background:rgba(192,19,19,1);border:3px solid rgba(7,80,8,1);border-radius:100%;box-shadow:0 -2px 0 3px #c91919 inset,0 5px 5px rgba(65,8,8,0.17),0 15px rgba(255,255,255,0.25) inset;cursor:pointer;display:inline-block;height:10vw;width:10vw;}.btn-red:hover{background:#333;box-shadow:0 -2px 0 3px #1a1a1a inset,0 5px 5px rgba(0,0,0,0.17),0 15px rgba(255,255,255,0.32) inset;}#borderDiv{}.animatedESWButtonDiv{}"]);
var config = {
  mass: 5,
  tension: 2000,
  friction: 5000
...
//# sourceMappingURL=index.js.bca1f0065fc4314248e7.hot-update.js.map
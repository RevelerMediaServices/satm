...
})(["font-family:\"Romanesco\",cursive;position:absolute;top:15vh;left:10vw;background:#a81414;background:linear-gradient(180deg,#a81414 0%,#125712 80%);background:-webkit-linear-gradient(180deg,#a81414 0%,#125712 80%);background:-moz-linear-gradient(180deg,#a81414 0%,#125712 80%);border-radius:10px 10px 10px 10px;-webkit-border-radius:10px 10px 10px 10px;-moz-border-radius:10px 10px 10px 10px;border:0.5vmax solid black;box-shadow:0.1vw 0.1vw 15px #fff;.animatedDiv{color:white;width:40vw;font-size:5vw;padding-left:5vw;padding-bottom:1vh;}.bringingJoy{}.permianBasin{}"]);
var config = {
  mass: 5,
  tension: 2000,
  friction: 5000
...
//# sourceMappingURL=index.js.d09d783cb085ce2d171a.hot-update.js.map
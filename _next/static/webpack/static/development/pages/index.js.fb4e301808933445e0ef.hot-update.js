...
})(["position:absolute;top:30vh;left:40vw;ul{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);margin:0;padding:2vw;display:flex;font-size:2.5vw;background-color:yellow;}ul li{list-style:none;}ul li a{position:relative;width:4vw;height:4vw;display:block;text-align:center;margin:0 0.75vw;border-radius:50%;padding:0.4vw;box-sizing:border-box;text-decoration:none;box-shadow:0 0.5vw 0.75vw rgba(0,0,0,0.3);background:linear-gradient(0deg,#ddd,#fff);transition:0.75s;color:rgba(192,8,8,1);}ul li a:hover{box-shadow:0 0.1vw 0.25vw rgba(0,0,0,0.3);color:rgba(8,80,8,1);}ul li a .fa{width:100%;height:100%;display:block;background:linear-gradient(0deg,#fff,#ddd);border-radius:50%;line-height:calc(6vw - 1.25vw);font-size:2.5vw;color:#262626;transition:0.5s;}ul li:nth-child(1) a:hover .fa{color:#3b5998;}ul li:nth-child(2) a:hover .fa{color:#00aced;}ul li:nth-child(3) a:hover .fa{color:#dd4b39;}"]);
...
//# sourceMappingURL=index.js.fb4e301808933445e0ef.hot-update.js.map
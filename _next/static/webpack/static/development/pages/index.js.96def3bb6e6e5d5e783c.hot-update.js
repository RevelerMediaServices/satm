...
})(["position:absolute;top:30vh;left:40vw;ul{position:absolute;top:50%;left:50%;transform:translate(-40%,-40%);margin:0;padding:0;display:flex;font-size:2.5vw;}ul li{list-style:none;}ul li a{position:relative;width:4.5vw;height:4.5vw;display:block;text-align:center;margin:0 0.75vw;border-radius:50%;padding:0;box-sizing:border-box;text-decoration:none;box-shadow:0 0.5vw 0.75vw rgba(0,0,0,0.7);background:linear-gradient(0deg,#ddd,#fff);transition:0.75s;color:rgba(192,8,8,1);border:solid black 0.05vw;}ul li a:hover{box-shadow:0 0.05vw 0.125vw rgba(0,0,0,0.3);color:rgba(8,80,8,1);}ul li a .fa{width:100%;height:100%;display:block;background:linear-gradient(0deg,#fff,#ddd);border-radius:50%;line-height:calc(6vw - 1.25vw);font-size:2.5vw;color:white;transition:0.5s;}"]);
...
//# sourceMappingURL=index.js.96def3bb6e6e5d5e783c.hot-update.js.map
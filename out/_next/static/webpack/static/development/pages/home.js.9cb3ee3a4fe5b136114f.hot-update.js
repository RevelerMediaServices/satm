...
function (_Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      {}
      var filteredResults = this.props.data.articles.filter(function (article) {
        return article.title.indexOf("qui") !== -1;
      });
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_3__["default"], {
        ...
        __self: this
      }, this.props.data.articles.map(function (article, key) {
        ...
        __self: this
      }, filteredResults.map(function (article, key) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
          key: key,
          __source: {
            fileName: _jsxFileName,
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return fetch("https://newsapi.org/v2/everything?q=christmas&from=2019-01-26&sortBy=publishedAt&apiKey=37b82fead6954eb48711defd794b1f68");
...
//# sourceMappingURL=home.js.9cb3ee3a4fe5b136114f.hot-update.js.map
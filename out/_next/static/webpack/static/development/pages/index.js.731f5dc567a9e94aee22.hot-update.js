...
})(["font-family:\"Romanesco\",cursive;position:absolute;top:15vh;left:10vw;background:#006400;background:linear-gradient(90deg,#006400 0%,#006400 80%);background:-webkit-linear-gradient(90deg,#006400 0%,#006400 80%);background:-moz-linear-gradient(90deg,#006400 0%,#006400 80%);border-radius:10px 10px 10px 10px;-webkit-border-radius:10px 10px 10px 10px;-moz-border-radius:10px 10px 10px 10px;.animatedDiv{color:white;width:40vw;font-size:5vw;padding-left:5vw;padding-bottom:1vh;}.bringingJoy{}.permianBasin{}"]);
var config = {
  mass: 5,
  tension: 2000,
  friction: 5000
...
//# sourceMappingURL=index.js.731f5dc567a9e94aee22.hot-update.js.map
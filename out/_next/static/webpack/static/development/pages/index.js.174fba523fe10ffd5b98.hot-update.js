...
})(["font-family:\"Romanesco\",cursive;position:absolute;top:15vh;left:10vw;background:#a81414;background:linear-gradient(17deg,#a81414 0%,#125712 80%);background:-webkit-linear-gradient(17deg,#a81414 0%,#125712 80%);background:-moz-linear-gradient(17deg,#a81414 0%,#125712 80%);border-radius:10px 10px 10px 10px;-webkit-border-radius:10px 10px 10px 10px;-moz-border-radius:10px 10px 10px 10px;border:0.5vmax solid black;box-shadow:0.1vmax 0.1vmax 10px #fff,0.3vmax 0.3vmax 5px #000;.animatedDiv{color:white;width:40vw;font-size:5vw;padding-left:5vw;padding-bottom:1vh;}.bringingJoy{}.permianBasin{}"]);
var config = {
  mass: 5,
  tension: 2000,
  friction: 5000
...
//# sourceMappingURL=index.js.174fba523fe10ffd5b98.hot-update.js.map
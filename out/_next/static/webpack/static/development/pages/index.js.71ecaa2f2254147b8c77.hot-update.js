...
})(["position:absolute;top:15vh;left:10vw;background:rgba(192,19,19,0.9);border:1vmax double rgba(7,80,8,1);border-radius:2vmax;font-weight:800;#borderdiv{margin:1vmax;border-radius:0.5vmax;}.animatedDiv{color:black;width:40vw;font-size:3.5vw;padding-left:0.5vw;padding-bottom:1vh;font-family:\"Mr Dafoe\",cursive;letter-spacing:0.3vw;text-shadow:0.05vmax 0.05vmax 10px #fff;text-shadow:4px 4px 2px rgba(150,150,150,1);}.bringingJoy{}.permianBasin{}"]);
var config = {
  mass: 5,
  tension: 2000,
  friction: 5000
...
//# sourceMappingURL=index.js.71ecaa2f2254147b8c77.hot-update.js.map
...
})(["position:absolute;top:30vh;left:40vw;ul{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);margin:0;padding:0;display:flex;}ul li{list-style:none;}ul li a{width:5vw;height:5vw;display:block;margin:0 0.75vw;border-radius:50%;font-size:2.5vw;padding-top:0.9vw;padding-left:1.2vw;box-sizing:border-box;text-decoration:none;box-shadow:0 0.5vw 0.75vw rgba(0,0,0,0.7);background:linear-gradient(0deg,#ddd,#fff);transition:0.75s;color:rgba(192,8,8,1);border:double black 0.05vw;}ul li a:hover{box-shadow:0 0.05vw 0.125vw rgba(0,0,0,0.3);color:rgba(8,80,8,1);}ul li a .fa{width:100%;height:100%;display:block;background:linear-gradient(0deg,#fff,#ddd);border-radius:50%;line-height:calc(6vw - 1.25vw);font-size:2.5vw;color:white;transition:0.5s;}"]);
...
//# sourceMappingURL=index.js.9902360a181524401e18.hot-update.js.map
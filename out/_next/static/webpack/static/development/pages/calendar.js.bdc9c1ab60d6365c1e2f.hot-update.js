...
})([".navbar-nav{float:none;margin:0 auto;display:block;text-align:center;a{font-weight:800;font-size:200%;}}.navbar-nav > li{display:block;float:none;}@media (min-width:768px){.navbar-nav{float:none;margin:0 auto;display:block;text-align:center;}.navbar-nav > li{display:inline-block;float:none;}}.navbarBrandLogo{opacity:0;}"]);
  ...
  _createClass(Navbar1, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(NavBarDiv, {
        ...
        __self: this
      }, "J. Graves"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_2__["NavbarToggler"], {
        ...
        type: "button",
        class: "btn btn-outline-danger navbar-btn btn-lg",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 87
        },
        ...
        type: "button",
        class: "btn btn-outline-danger navbar-btn",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 103
        },
...
//# sourceMappingURL=calendar.js.bdc9c1ab60d6365c1e2f.hot-update.js.map